...
simulate_full_trial_sptncc <- function(n_arms,
  ...
  recruitment <- simulate_recruitment_sptncc(
    n_arms = n_arms,
  ...
  outcomes <- simulate_trial_outcomes_sptncc(
    recruitment_data = recruitment$recruitment_details,
  ...
  type1 <- simulate_type1_error_sptncc(
    recruitment_data = recruitment$recruitment_details,
