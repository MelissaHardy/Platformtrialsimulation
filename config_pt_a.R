#####################################################################
#### Trial Design Parameters for the platform trials (Scenario A)####
#####################################################################
...
n_arms <- 5 # Number of treatment arms including the control arm

patients_per_experimental_arm <- 60 # Total number of patients in each arm for scenario A
