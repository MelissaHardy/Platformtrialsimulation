...
# Total number of patients the platform trial - change to from 300 to 465 for 2nd study
nPatients <- 465 

n_arms <- 5 # Number of treatment arms including BAT

# Total number of patients in each arm - change from 60 to 93 for 2nd study
patients_per_experimental_arm <- 93
death0 <- 0.41
death1 <- 0.36
